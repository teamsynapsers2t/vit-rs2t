  ...
  return (
    <div className="max-w-[1400px] mx-auto pb-12">
      ...
      <div className="mt-8 flex justify-end">
        <button 
          onClick={onNext}
          className="bg-[#1C3A2F] hover:bg-[#2E5E45] text-white px-8 py-4 rounded-full font-bold flex items-center gap-2 shadow-lg transition-all group whitespace-nowrap"
        >
          {Math.abs(remaining) > 0.05 ? `Proceed with Deficit (₹${remaining.toFixed(2)} L Cr)` : "Proceed to Next Step"}
